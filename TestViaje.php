...
$objPasajero1 = new Pasajero("Cyntia","Nasabun",'34811057',"4773300","4","1888");

$objPasajero2 = new PasajeroVIP("Emilio","Lopez","40888211","2995848586","1","1892","5685555","350");

$objPasajero3 = new PasajeroEspecial("Jose","Sanchez","11225481","2996872233","5","2004","false","false","true");

$objPasajero4 = new Pasajero("","","","","","");

$objResponsable = new ResponsableV("","","","");

$arrayPasajeros = [$objPasajero1,$objPasajero2,$objPasajero3,$objPasajero4];

$viaje = new Viaje("404","San Martin","4",$arrayPasajeros,$objResponsable,"35000","70000");





$hay = $viaje->hayPasajesDisponible();
if ($hay == true){
